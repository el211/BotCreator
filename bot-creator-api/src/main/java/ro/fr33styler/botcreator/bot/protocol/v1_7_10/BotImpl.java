package ro.fr33styler.botcreator.bot.protocol.v1_7_10;
...
import ro.fr33styler.botcreator.bot.protocol.v1_7_10.network.ClientHandler;
import ro.fr33styler.botcreator.bot.protocol.v1_7_10.network.coder.PacketDecoder;
import ro.fr33styler.botcreator.bot.protocol.v1_7_10.network.coder.PacketEncoder;
import ro.fr33styler.botcreator.bot.protocol.v1_7_10.network.packets.StageType;
import ro.fr33styler.botcreator.bot.protocol.v1_7_10.network.packets.play.ServerBoundChatPacket;
    ...
    public void connect(EventLoopGroup workerGroup, String host, int port) {
        ...
        bootstrap.handler(new ChannelInitializer<SocketChannel>() {
            ...
            public void initChannel(SocketChannel channel) {
                channel.pipeline().addLast(new PacketEncoder(), new PacketDecoder(options), new ClientHandler(options));
            }
